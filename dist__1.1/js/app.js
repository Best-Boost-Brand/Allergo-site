(() => {
    ...
    function handleQuantityClick(e) {
        ...
        if (targetElement.closest("[data-quantity-plus]") || targetElement.closest("[data-quantity-minus]")) {
            quantityWrapper = targetElement.closest("[data-quantity]");
            if (quantityWrapper) {
                const valueElement = quantityWrapper.querySelector("[data-quantity-value]");
                let value = parseInt(valueElement.value, 10);
                ...
                console.log(value);
                if (value === 0) {
                    const targetId = quantityWrapper.getAttribute("data-target");
                    quantityWrapper.style.display = "none";
                    const button = document.querySelector(`.nav__busket-btn[data-target="${targetId}"]`);
                    if (button) button.style.display = "block";
                }
            }
        }
        if (targetElement.closest(".nav__img")) {
            const navImgElement = targetElement.closest(".nav__img");
            const targetId = navImgElement.previousElementSibling.getAttribute("data-target");
            quantityWrapper = document.querySelector(`[data-quantity][data-target="${targetId}"]`);
            if (quantityWrapper) {
                const valueElement = quantityWrapper.querySelector("[data-quantity-value]");
                let value = parseInt(valueElement.value, 10);
                if (value === 0) {
    ...
    document.addEventListener("DOMContentLoaded", (function() {
        ...
        if (buttons.length > 0) buttons.forEach((button => {
            button.addEventListener("click", (function() {
                ...
                if (previousButton) previousButton.style.backgroundColor = "#c4c4c4";
    ...
    document.addEventListener("click", (function(event) {
        if (event.target.closest(".amount__btn")) window.location.href = "lastOrderPageDelivery.html";
    }));
    document.addEventListener("DOMContentLoaded", (function() {
        menuInit();
    }));
    document.addEventListener("click", (function(event) {
        if (event.target.closest(".aproove__btn")) window.location.href = "thankyouPage.html";
    }));
    const dishesData = [ {
        id: 1,
        name: "first_dishes",
    ...
    document.addEventListener("click", (function(event) {
        if (event.target.closest(".nav__busket-btn")) {
            ...
            const quantityBlock = document.querySelector(`.quantity[data-target="${targetId}"]`);
            if (quantityBlock) quantityBlock.style.display = "block";
            let selectedDish;
            ...
            } else console.error("Dish not found for ID:", targetId);
        }
    }));
    document.addEventListener("DOMContentLoaded", (function() {
        const storedOrders = JSON.parse(localStorage.getItem("orders")) || [];
        ...
        } else lastAproove.innerHTML = `<p>Ваш кошик порожній</p>`;
    }));
    document.querySelector(".nav__busket-btn");
    document.addEventListener("DOMContentLoaded", (function() {
        displayFirstDishes(dishesData);
        formQuantity();
        ...
        document.addEventListener("click", (function(event) {
            if (event.target.closest("[data-quantity-plus], [data-quantity-minus]")) {
                ...
                const quantityInput = quantityBlock.querySelector("[data-quantity-value]");
    ...
    document.addEventListener("DOMContentLoaded", (function() {
        ...
        if (savedMap) {
            ...
            document.getElementById("lastAproove");
            let totalPrice = 0;
            dishesData.forEach((category => {
        ...
        } else console.error("Немає даних у localStorage");
        quantitiy, dish.caption, dishTotalPrice, dishTotalPrice;
    ...
    document.addEventListener("DOMContentLoaded", (function() {
        if (window.location.pathname.includes("orders")) {
            ...
            images.forEach((img => {
                if (img.complete && img.naturalHeight !== 0) console.log("Image loaded successfully:", img.src); else console.error("Image not loaded:", img.src);
            }));
            document.addEventListener("click", (function(event) {
                if (event.target.closest(".nav__busket-btn")) {
                    ...
                    const quantityBlock = document.querySelector(`.quantity[data-target="${targetId}"]`);
                    if (quantityBlock) quantityBlock.style.display = "block"; else console.error(`Quantity block not found for targetId: ${targetId}`);
                }
            }));
        } else console.log("This is not the orders page.");
    }));
    document.addEventListener("click", (function(event) {
    ...
    document.addEventListener("DOMContentLoaded", (function() {
        ...
        if (hideMapButton) hideMapButton.addEventListener("click", (function() {
            localStorage.setItem("hideMap", "true");
            localStorage.removeItem("visibleMap");
            if (mapElement) mapElement.style.display = "none";
        }));
        if (showMapButton) showMapButton.addEventListener("click", (function() {
        ...
        if (hideMap === "true" && mapElement) mapElement.style.display = "none"; else if (visibleMap === "true" && mapElement) mapElement.style.display = "block";
    }));
    document.addEventListener("DOMContentLoaded", (function() {
        ...
        if (deliverySelect && mapSection) {
            ...
            const hideMap = localStorage.getItem("hideMap");
            const visibleMap = localStorage.getItem("visibleMap");
            if (hideMap === "true") mapSection.style.display = "none"; else if (visibleMap === "true") mapSection.style.display = "block"; else mapSection.style.display = deliverySelect.value === "1" ? "none" : "block";
        }
    }));
    document.addEventListener("DOMContentLoaded", (function() {
        const deliverySelect = document.querySelector(".delivery__form");
        ...
        if (deliverySelect && mapSection && curierAddressSection) {
            deliverySelect.addEventListener("change", (function() {
                ...
                if (selectValue === "1") {
                    mapSection.style.display = "none";
                    curierAddressSection.style.display = "block";
                    localStorage.setItem("hideMap", "true");
    ...
    document.querySelector(".nav__busket-btn").addEventListener("click", (function() {
        this.style.display = "none";
        document.querySelector(".quantity").style.display = "block";
    }));
    document.addEventListener("click", (function(event) {
        if (event.target.closest(".page__bigbasket-btn")) window.location.href = "aprooveOrderPage.html";
    }));
    document.addEventListener("click", (function(event) {
        if (event.target.closest(".amount__btn")) window.location.href = "lastOrderPage.html";
    }));
    document.addEventListener("DOMContentLoaded", (function() {
        console.log("DOM fully loaded and parsed");
        ...
        } else console.error("Button with ID 'red' not found!");
    }));
    window["FLS"] = true;
    menuInit();
    formQuantity();
